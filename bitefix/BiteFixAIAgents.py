...
class BiteFixAIAgents:
    ...
    def DiagnosisAgent(self) -> Agent:
        ...
        return Agent(
            ...
            backstory=
            f"""You are an expert in diagnosing python code errors. Your code diagnosis skills are unmatched. 
    ...
    def IdeaGeneratorAgent(self) -> Agent:
        ...
        return Agent(
            ...
            backstory=
            f"""You are an expert in generating ideas on how to fix the error. 
    ...
    def IdeasEvaluatorAgent(self) -> Agent:
        ...
        return Agent(
            ...
            backstory= 
            f"""You are an expert in evaluating the error fix ideas choosing the best idea to fix the error.
    ...
    def CodeDeveloperAgent(self) -> Agent:
        ...
        return Agent(
            ...
            backstory=
            f"""You are an expert in writing the code to fix the error. 
